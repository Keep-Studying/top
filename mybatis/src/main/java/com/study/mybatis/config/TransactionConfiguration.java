 ...
 *
 * @author boyan
 * @version : TransactionConfiguration.java, v 0.1 2021年07月17日 10:16 下午 boyan Exp $
 */
@Configuration
...
public class TransactionConfiguration {
     ...
     * @Pointcut("execution(* com.aloudata.ams.common.dal..daointerface.*.*(..) )")
     */
    private static final String AOP_POINTCUT_EXPRESSION = "execution (* com.study.mybatis.config..*.daointerface..*.*(..))";
